...
export default {
  ...
  methods: {
    createData () {
          ...
          series: [
            {
              ...
              radius: '80%',
              data: [
                { name: '已处理占比', value: randomExtend(40, 60) }
              ],
              axisLabel: {
                show: false
              },
      ...
      this.cards.title=['武昌区','江汉区','洪山区','汉阳区','青山区']
    },
